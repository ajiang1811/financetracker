...
// libs/embed-libs/embed/src/index.libs.ts
var index_libs_exports = {};
__export(index_libs_exports, {
  LuzmoDashboardWebComponent: () => LuzmoDashboardWebComponent
});
module.exports = __toCommonJS(index_libs_exports);
...
LuzmoDashboardWebComponent = __decorateClass([
  (0, import_decorators2.customElement)("luzmo-dashboard-web-component")
