...
// libs/embed-libs/embed/src/lib/dashboard-component/dashboard-web-component.ts
import { customElement } from "lit/decorators.js";

// libs/embed-libs/embed/src/lib/dashboard-component/dashboard-base.ts
import * as SharedLib2 from "@luzmo/shared-embed";
import {
  html,
  LitElement
} from "lit";
...
import {
  __federationMethodGetRemote,
  __federationMethodWrapDefault,
  remotesMap,
  luzmoEmbedContainerClass
...
// libs/embed-libs/embed/src/lib/dashboard-component/dashboard-base.ts
var LuzmoDashboard = class extends LitElement {
  ...
  loadLibrary(appServer) {
    if (remotesMap[appServer]) {
      return Promise.resolve(remotesMap[appServer].module);
    }
    ...
    return __federationMethodGetRemote(appServer, "./DashboardApp").then((module) => {
      const wrappedModule = __federationMethodWrapDefault(module, true);
  ...
  render() {
    ...
    `;
    if (this.getIsViewMode()) {
      toBeRenderedHTML = this.isLibraryLoaded ? html`
          ${this.dashboardId || this.dashboardSlug ? html`
            <dashboard-component dashboard-id="${this.params.dashboardId}" app-server="${this.params.appServer}"
                                 api-host="${this.params.apiHost}"></dashboard-component>` : html`
...
__decorateClass([
  query(`.${luzmoEmbedContainerClass}`)
...
// libs/embed-libs/embed/src/lib/dashboard-component/dashboard-web-component.ts
var LuzmoDashboardWebComponent = class extends LuzmoDashboard {
};
LuzmoDashboardWebComponent = __decorateClass([
  customElement("luzmo-dashboard-web-component")
], LuzmoDashboardWebComponent);
export {
  LuzmoDashboardWebComponent
};
